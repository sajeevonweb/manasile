...
import { QUESTIONS_PER_PAGE, calculateStandardScores } from '../data/standard';
import { getStandardQuestions } from '../translations';
...
export default function StandardAssessment() {
  ...
  const questions = useMemo(() => 
    getStandardQuestions((assessment?.language as Language) || 'en'), 
    [assessment?.language]
  );
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const calculatedScores = calculateStandardScores(numericResponses, questions);
      const scores = {
